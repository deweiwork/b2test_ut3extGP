...
COPY v6_gtxwizard_v1_12_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\v6_gtxwizard_v1_12_top.ucf -p xc6vhx380t-ff1923-2 v6_gtxwizard_v1_12_top.ngc v6_gtxwizard_v1_12_top.ngd
