...
COPY v6_gtxwizard_v1_12_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\v6_gtxwizard_v1_12_top.ucf -p xc6vhx380t-ff1923-2 v6_gtxwizard_v1_12_top.edf v6_gtxwizard_v1_12_top.ngd
...
ECHO 'Running NGD'
map -p xc6vhx380t-ff1923-2 -o mapped.ncd v6_gtxwizard_v1_12_top.ngd
...
netgen -ofmt vhdl -sim -dir . -tm v6_gtxwizard_v1_12_top -w routed.ncd routed.vhd
